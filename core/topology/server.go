...
import (
	...
	"go.mongodb.org/mongo-driver/core/auth"
...
func (s *Server) BuildCursor(result bson.Raw, clientSession *session.Client, clock *session.ClusterClock, opts ...option.CursorOptioner) (command.Cursor, error) {
